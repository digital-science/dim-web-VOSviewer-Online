...
import InfoPanel from 'components/ui-dimensions/InfoPanel';
...
import dimensionsLogoDark from 'assets/images/dimensions-logo-dark.svg';
...
const Dimensions = observer(({ queryString = {}, fullscreenHandle }) => {
  ...
  }, [vosviewerLogoEl, dimensionsLogoEl]);
